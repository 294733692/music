        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-right">
              <i class="icon" @click="toogleFavorite(currentSong)" :class="getFavoriteIcon(currentSong)"></i>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    middleTouchMove(e) {
      ...
      const touch = e.touches[0];
      const detalX = touch.pageX - this.touch.stratX;
      const detalY = touch.pageY - this.touch.stratY;
      // 阻止横向滚动
      ...
      const offsetWidth = Math.min(
        0,
        Math.max(-window.innerWidth, left + detalX)
      );
